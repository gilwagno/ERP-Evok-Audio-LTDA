 ...
 * exatamente o mesmo formato JSON do controller legado
 * (`server/src/controllers/bomController.js`), que permanece no
 ...
 * `action: 'approve'` (mesma detecção `isApproval` do controller legado).
...
exports.update = async (req, res, next) => {
  try {
    ...
    // status) para preservar 100% o comportamento do controller legado, que
