...
/** Campos gerais da BOM que podem ser alterados via `PUT /:id` (mesmos do controller legado). */
 ...
 * inline no `bomController.update` legado, agora explicitada em dois use
 * cases dedicados.
 */
