...
/**
 * Implementação Sequelize/MySQL de `UsersRepository`, usando exclusivamente
 * o model `User` já existente em `server/src/models/User.js` — nenhum
...
class SequelizeUsersRepository extends UsersRepository {
   ...
   * @returns {Promise<{ rows: Object[], count: number }>} Mesma lógica de busca/filtro/paginação do controller legado.
   */
