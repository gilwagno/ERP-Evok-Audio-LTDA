...
/**
 * Implementação Sequelize/MySQL do contrato `PurchaseRepository`.
 *
 ...
 * este módulo. As queries reproduzem exatamente as do controller legado
 * `server/src/controllers/purchaseController.js`.
 */
class SequelizePurchaseRepository extends PurchaseRepository {
  /** @inheritdoc */
  async listPurchases(filters = {}, pagination = {}) {
    const where = {};
