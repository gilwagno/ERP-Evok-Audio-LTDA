...
const ProductionOrder = sequelize.define('ProductionOrder', {
  ...
  quantity: { type: DataTypes.INTEGER, allowNull: false, comment: 'Quantidade planejada' },
  quantity_produced: { type: DataTypes.INTEGER, defaultValue: 0, comment: 'Quantidade produzida' },
